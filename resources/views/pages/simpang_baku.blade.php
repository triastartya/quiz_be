    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h3 class="card-title">Data Simpang baku</h3>
            </div>
            <div class="card-body">
                <div class="row" >
                    <div class="col-md-12">
...
app.controller("myCtrl", function($scope,$http) {
    ...
    var table =  $('#listdatatable').DataTable({
            ...
            columns: [
                ...
                { title:"min_3_SD",   "data": "min_3_SD" },
                { title:"min_2_SD",   "data": "min_2_SD" },
                { title:"min_1_SD",   "data": "min_1_SD" },
                { title:"Median",   "data": "Median" },
                { title:"plus_1_SD",   "data": "plus_1_SD" },
                { title:"plus_2_SD",   "data": "plus_2_SD" },
                { title:"plus_3_SD",   "data": "plus_3_SD" },
    ...
    $scope.reloadlist = function(){
        ...
        table.clear().draw();
        $http.get("{{ url('api/simpang_baku') }}").then(function(res){
