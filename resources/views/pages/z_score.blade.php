    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h3 class="card-title">Data Status Gizi</h3>
            </div>
            <div class="card-body">
                <div class="row" >
                    <div class="col-md-12">
...
app.controller("myCtrl", function($scope,$http) {
    ...
    var table =  $('#listdatatable').DataTable({
            ...
            columns: [
                ...
                {{-- { title:"tanggal_periksa",    "data": "tanggal_periksa" }, --}}
                { title:"jenis_kelamin",  "data": "jenis_kelamin" },
                { title:"berat_badan",   "data": "berat_badan" },
                { title:"tinggi_badan",   "data": "tinggi_badan" },
                { title:"umur_tahun",   "data": "umur_tahun" },
                { title:"umur_bulan",   "data": "umur_bulan" },
                { title:"nilai_individu_subject",   "data": "nilai_individu_subject" },
                { title:"nilai_median_baku_rujukan",   "data": "nilai_median_baku_rujukan" },
                { title:"nilai_simpang_baku_rujukan",   "data": "nilai_simpang_baku_rujukan" },
                { title:"z_score",   "data": "z_score" },
    ...
    $scope.reloadlist = function(){
        ...
        table.clear().draw();
        $http.get("{{ url('api/z_score') }}").then(function(res){
